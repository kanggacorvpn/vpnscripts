...
# Data Telegram
CHATID="6986825986"
KEY="7382689661:AAETTqUALspBWTSOzKsCVvh8IdyabxPFNow"
URL="https://api.telegram.org/bot$KEY/sendMessage"

# Repositori
REPO="https://raw.githubusercontent.com/kanggacorvpn/vpnscripts/main/"
...
username=$(curl https://raw.githubusercontent.com/kanggacorvpn/vps_access/main/ip | grep $IP_VPS | awk '{print $2}')
echo "$username" >/usr/bin/user

# Save Expired Detail in github to /usr/bin/e
expx=$(curl https://raw.githubusercontent.com/kanggacorvpn/vps_access/main/ip | grep $IP_VPS | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/kanggacorvpn/vps_access/main/ip | grep $IP_VPS | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/kanggacorvpn/vps_access/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/kanggacorvpn/vps_access/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/BYORKANISMM"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6287740819772"}]]}'
...
wget raw.githubusercontent.com/kanggacorvpn/vpnscripts/main/files/limit-quota.sh && chmod +x limit-quota.sh && ./limit-quota.sh
print_install "Memasang Service Locked xray"
wget raw.githubusercontent.com/kanggacorvpn/vpnscripts/main/lock-service.sh && chmod +x lock-service.sh && ./lock-service.sh
cd
...
# install menu shell
wget ${REPO}feature/KANGGACOR_sh
unzip KANGGACOR_sh
chmod +x menu/*
...
# install menu py
wget ${REPO}feature/KANGGACOR_py
unzip KANGGACOR_py
chmod +x menu/*
mv menu/* /usr/bin
rm -rf menu
...
cd
wget raw.githubusercontent.com/kanggacorvpn/vpnscripts/main/ws-switch
mv ws-switch /usr/local/bin
